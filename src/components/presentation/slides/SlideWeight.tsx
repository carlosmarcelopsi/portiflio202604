  ...
  <SlideLayout backgroundImage="/images/accident-bg.jpg" overlay="dark">
    <div className="flex flex-col items-center justify-center h-full px-[100px]">
      <div className="text-center animate-scale-in mb-[40px]">
        <h2 className="slide-title-lg text-gold-gradient leading-tight mb-[20px]">
          Qual o PESO de um<br />adoecimento, assédio<br />ou afastamento?
        </h2>
        <div className="w-[120px] h-[3px] mx-auto my-[30px]" style={{ background: "hsl(40 70% 55%)" }} />
        <div className="slide-label text-gold-gradient mb-[16px]">Você sabe...</div>
