  ...
  <SlideLayout backgroundImage="/images/homeoffice-bg.jpg" overlay="gradient-left">
    <div className="flex h-full">
      <div className="w-[55%] flex flex-col justify-center px-[120px]">
        <div className="slide-label text-gold-gradient mb-[24px] animate-fade-in-up">Revista Exame · Fev 2026</div>
        ...
        <div className="space-y-[24px]">
          {[
            ...
            <div key={i} className={`flex items-baseline gap-[20px] animate-fade-in-up delay-${(i + 3) * 100}`}>
