  ...
  <SlideLayout>
    <div className="flex h-full" style={{ background: "linear-gradient(135deg, hsl(220 50% 8%), hsl(220 35% 14%))" }}>
      ...
      <div className="w-[600px] flex items-center justify-center animate-fade-in">
        <img src="/images/profile-light.jpg" alt="Carlos Marcelo" className="h-[900px] object-cover rounded-[20px] shadow-2xl" />
      </div>
      {/* Bio */}
      <div className="flex-1 flex flex-col justify-center px-[80px]">
        ...
        <p className="slide-subtitle animate-fade-in-up delay-200 mb-[40px]" style={{ color: "hsl(40 70% 55%)" }}>Psicólogo</p>
