...
const SlideTestimonials = () => (
  <SlideLayout>
    <div className="flex flex-col h-full px-[70px] py-[50px]" style={{ background: "linear-gradient(135deg, hsl(220 50% 8%), hsl(220 35% 14%))" }}>
      <div className="text-center mb-[32px]">
        <div className="slide-label text-gold-gradient mb-[12px] animate-fade-in-up">O que dizem</div>
      ...
      <div className="flex-1 flex gap-[24px] items-stretch">
        {testimonials.map((item, i) => (
          <div key={i} className={`flex-1 p-[32px] rounded-[20px] flex flex-col justify-between animate-fade-in-up delay-${(i + 2) * 100}`}
